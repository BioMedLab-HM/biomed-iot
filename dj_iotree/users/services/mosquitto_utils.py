...
class MqttMetaDataManager:
    ...
    def _get_or_create_mqtt_meta_data(self):
        ...
        with transaction.atomic():
            try:
                ...
                print(
                    "Integrity-Error while trying to create MqttMetaData. Check if MqttMetaData already exists"
                )
    ...
    def create_nodered_role(self):
        ...
        if self.metadata is not None:
            ...
            with MosquittoDynSec(self.dynsec_username, self.dynsec_password) as dynsec:
                success, _, _ = dynsec.create_role(
    ...
    def delete_device_role(self):
        ...
        if self.metadata is not None:
            ...
            #MosquittoDynSec(self.dynsec_username, self.dynsec_password)
            with MosquittoDynSec(self.dynsec_username, self.dynsec_password) as dynsec:
...
class MqttClientManager:
    ...
    def create_client(self, textname="New Device", role_type=None):
        ...
        try:
            ...
            #MosquittoDynSec(self.dynsec_username, self.dynsec_password)
            with MosquittoDynSec(self.dynsec_username, self.dynsec_password) as dynsec:
                success, response, _ = dynsec.create_client(
                new_username, new_password, textname=textname, roles=roles
            )
    ...
    def modify_client(self, client_username, textname="New MQTT Device"):
        ...
        try:
            ...
            if success:
                ...
                mqtt_client.save()
                print(
                    f"MQTT client {client_username}'s textname updated to '{textname}' successfully."
                )
            else:
                print(
