...
def main():
	...
	if not auto_generate_django_admin_credentials:
		django_admin_email = get_confirmed_text_input('Enter a username for ' "your website's admin user")

		print('Enter and remember a safe password (>= 12 characters) ' 'for your Biomed IoT admin user')
