...
class GrafanaUserManager:
    ...
    def __init__(self, user):
        ...
        self.influx_org_id = config.influxdb.INFLUX_ORG_NAME
    ...
    def _make_data_source(self):
        ...
        payload += '","token":"'
        payload += self.influx_token
        payload += '"}, "jsonData":{"httpMode": "GET", "version": "InfluxQL", "httpHeaderName1": "Authorization", "organization": "iotree42"}'  # {self.influx_org_id}
