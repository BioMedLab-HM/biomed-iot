...
MOSQUITTO_PORT_EXTERNAL = "{MOSQUITTO_PORT_EXTERNAL}"
MOSQUITTO_PORT_INTERNAL = "{MOSQUITTO_PORT_INTERNAL}"
MOSQUITTO_PORT_DOCKER = "{MOSQUITTO_PORT_DOCKER}"
...
INOUT_TOPIC_ENABLED = "{INOUT_TOPIC_ENABLED}"
