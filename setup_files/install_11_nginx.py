...
def install_nginx(setup_scheme, domain, server_ip, hostname):
    ...
    if setup_scheme == 'TLS_WITH_DOMAIN':
        ...
        commands = [
            ...
            'openssl dhparam -out /etc/nginx/dhparam.pem 4096',  # Takes a long time. Do this only on fast computers.
        ...
        commands = [
            ...
            'openssl dhparam -out /etc/nginx/dhparam.pem 2048', # 4096 is recommended for public sservers
