...
def install_influxdb(architecture):
	...
	influx_org_id = run_bash("influx org list | awk '/biomed-iot/ && NR>1 {print $1}'", show_output=False).strip()
	...
	# chmod 755 ./biomed_iot/staticfiles  # or for user directory alltogether
	return config_data
